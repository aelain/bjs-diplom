...
Проект - подготовленный сайт-биржа для крипто-стартапа.

## Задачи

Связать две подготовленные части сайта: интерфейс взаимодействия с АPI и интерфейс взаимодействия с DOM.

Сделать так, чтобы данные, введённые пользователем, отправлялись на сервер, а информация, предоставленная сервером, отобразилась пользователю.
...
Проверяющий эксперт (преподаватель): Светлана Коробцева

## Результат

[Код страницы «Вход и регистрация»](https://github.com/aelain/bjs-diplom/blob/master/public/loginPage.js)

[Код страницы «Личный кабинет пользователя»](https://github.com/aelain/bjs-diplom/blob/master/public/homePage.js)
